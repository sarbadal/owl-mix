...
The :class:`CausalityAnalyzer` class offers a convenient interface for causality analysis, 
...
.. py:class:: CausalityParams(target_column=None, columns=None, max_lag=10, precision=4, error_threshold=0.15, p_value_weight=0.6, mape_weight=0.4)
...
.. py:class:: CausalityAnalyzer(df, params)
